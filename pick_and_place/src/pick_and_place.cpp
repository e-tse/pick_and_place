...
void MTCTaskNode::doTask()
{
  ...
  RCLCPP_ERROR_STREAM(LOGGER, "Pre planning");
  if (!task_.plan(1))
  {
    RCLCPP_ERROR_STREAM(LOGGER, "Task planning failed");
    return;
  }
    RCLCPP_ERROR_STREAM(LOGGER, "passed a");
  task_.introspection().publishSolution(*task_.solutions().front());
  RCLCPP_ERROR_STREAM(LOGGER, "passed b");
  // task_.introspection().publishSolution(*task_.solutions().front());
...
mtc::Task MTCTaskNode::createTask()
{
  ...
  const auto& hand_frame = "wx250s/ee_gripper_link";
...
#pragma GCC diagnostic pop
  ...
  stage_open_hand->setGoal("Released");
  ...
  //    ***************************************************/
    {
      ...
      stage->setPreGraspPose("Released");
